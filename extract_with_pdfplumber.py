...
class  plumber_processor:
    ...
    def scan_single_page(self,pdf_path, page_index=0):
        """
    ...
    def extract_formatted_well_data(self,pdf_path, page_index=0):
        ...
        with pdfplumber.open(pdf_path) as pdf:
            ...
            #  Extract Well Name (Usually between 'Name and Number' and 'Qtr-Qtr')
            ...
            #  Extract County (Common ND counties)
